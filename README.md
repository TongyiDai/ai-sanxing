<p align="center">
  <img src="assets/hero.svg" alt="三省 AI 身 · AI 曰：任务三省吾身" width="100%">
</p>
...
三省 AI 身就补这一环。在 AI 说"搞定了"之前，逼它先停一下，换成一个挑剔审稿人的眼光，把刚写的东西当成**别人交上来的作业**来挑刺，挑完再改，然后才交给你。
...
- **设成默认**：在宿主 Agent 的 `AGENTS.md` / `CLAUDE.md` 里加一句"收尾前先按 三省 AI 身自审一轮"。
